...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
    ...
    test('retorna o objeto correto para o parâmetro Arya', () => {
    ...
    test('Função retorna o objeto correto para Brienne', () => {
  ...
  phrases: [
    ...
    test('Função retorna o objeto correto para Melissandre', () => {
  ...
  phrases: [
   ...
   test('Retorna undefined caso seja especificado um nome existente', () => {
    expect(getCharacter('matheus')).toBe(undefined)
})
});
